    ...
    <section class="content" id="section-data">
        <div class="panel panel-default wrap-table">
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12">
                      <h3>Selamat datang <b><?php echo $this->session->userdata('ses_name') ?></b> sebagai Tim Penilai</h3>
                    </div>                      
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-6">
                      <div class="small-box bg-yellow">
                        ...
                        <a href="<?php echo base_url('penilai/pengusul') ?> " class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
                </div>
            </div>
