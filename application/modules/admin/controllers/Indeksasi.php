...
class Indeksasi extends MY_Controller {
	...
	public function __construct(){
      ...
      $this->load->model('Indeksasi_model','m_data');
    }
    ...
    protected function is_related($id){
		...
		protected function validate($mode=null){
	        ...
	        $this->form_validation->set_rules('input_name'  ,'Nama' ,'trim|max_length[50]|required');
	        $this->form_validation->set_rules('input_keterangan'  ,'Keterangan' ,'trim|max_length[200]|required');
		}  
