        ...
        <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
          <div class="panel panel-default">
            <div class="panel-body">
              <h3 class="thin text-center">Verifikasi Gagal</h3>
              <p class="text-center text-muted">Kode verifikasi tidak valid atau anda telah terverifikasi oleh system, silahkan login <a href="<?php echo base_url('login')?>">Login</a> atau gunakan fasilitas Reset Password <a href="<?php echo base_url('forgot')?>">Lupa Password</a> </p>
              <hr>          
            </div>
          </div>
